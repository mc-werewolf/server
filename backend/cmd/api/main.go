...
func main() {
	...
	addonIDs := strings.Split(getEnv("LAUNCHER_ADDON_IDS", "kairo,kairo-database,werewolf-gamemanager,werewolf-vanillapack,werewolf-additionalroles-1,werewolf-additionalroles-4,werewolf-bds-bridge"), ",")
